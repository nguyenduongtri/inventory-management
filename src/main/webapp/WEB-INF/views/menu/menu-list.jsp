				...
				<div class="x_content">
					...
					<div class="table-responsive">
						<table class="table table-striped jambo_table bulk_action">
							<thead>
								<tr class="headings">
									<th rowspan="2" class="column-title" style="boder-left: 2px solid;">#</th>
									<th rowspan="2" class="column-title" style="boder-left: 2px solid;">Url</th>
									<th rowspan="2" class="column-title" style="boder-left: 2px solid;">Status</th>
									<th colspan="${roles.size()}" class="column-title text-center" style="boder-left: 2px solid;">Role</th>
								</tr>
								<tr>
